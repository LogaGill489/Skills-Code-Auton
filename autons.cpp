...
int DRIVE_SPEED = 22; // This is 110/127 (around 87% of max speed).  We don't suggest making this 127.
...
//sets pneumatic ports
pros::ADIAnalogOut endgameLeft ('B');
pros::ADIAnalogOut endgameRight ('C');
...
//TEMP CODE FOR 155 ROUTE
//COMMENT OUT IF GOING FOR A 200 ROUTE
...
//drives to launch position
chassis.set_drive_pid(-8, DRIVE_SPEED, true);
chassis.wait_drive();

//rotates to be in line for endgame launch
...
//USE FOR 200 POINTS
//CURRENTLY NOT FINISHED SO DONT RUN THIS
...
//auton that only runs endgame for 70ish points
void skills_auton_endgame() {
  ...
  //loops forever / until switched to driver control
  while (true) {
  pros::delay(20);
}
}
